    ...
    emailjs
      ...
      .then(
        ...
        (err) => {
          ...
          setIsSubmitting(false);
          alert(
            "Submission gateway offline. Please check connectivity matrix.",
          );
        },
      );
  };
        ...
        <div className="text-center z-10 max-w-3xl px-4">
          ...
          <p className="text-gray-400 font-light text-xs md:text-sm tracking-[0.4em] uppercase mb-12 max-w-xl mx-auto leading-relaxed">
            ...
            <span className="text-gray-600">
              Designed in Midnight Hues. Est. 2026.
            </span>
          </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 md:py-32">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-4">
          <div>
            ...
            <h2 className="text-3xl font-extralight uppercase tracking-widest mt-2">
              The Curated Matrix
            </h2>
          </div>
          <Link
            to="/shop"
            className="text-xs uppercase tracking-[0.2em] text-gray-400 hover:text-[#C5A880] transition-colors border-b border-gray-800 pb-1"
          >
            Browse Entire Index →
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {lookbookHighlights.map((item) => (
            <Link
              key={item.id}
              to="/shop"
              className="group block cursor-pointer relative overflow-hidden bg-[#121212] border border-gray-950 p-4 hover:border-gray-800 transition-all duration-500"
            >
              <div className="overflow-hidden aspect-[4/5] mb-6 pointer-events-none">
                <img
                  src={item.img}
                  alt={item.title}
              ...
              <div className="flex justify-between items-start pointer-events-none">
                <div>
                  ...
                  <h3 className="text-lg font-light uppercase tracking-wide text-white group-hover:text-[#C5A880] transition-colors">
                    {item.title}
                  </h3>
                </div>
        ...
        <div className="max-w-xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <button
              ...
              type="submit"
              className="bg-[#C5A880] text-black text-xs font-semibold tracking-widest uppercase px-8 py-3 hover:bg-[#b3966e] transition-colors disabled:opacity-50 cursor-pointer"
            >
